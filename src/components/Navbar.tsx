...
const Navbar = ({ isSidebarOpen, toggleSidebar }: NavbarProps) => {
  ...
  return (
    <nav className="sticky top-0 z-40 w-full border-b backdrop-blur-lg bg-background/80 transition-colors duration-300">
      <div className="flex h-10 md:h-16 items-center px-2 md:px-4 justify-between">
        ...
        <div className="flex items-center gap-0.5 md:gap-2">
          <div className="flex items-center gap-0.5 md:gap-2">
            <Button variant="ghost" size="icon" className="relative h-6 w-6 md:h-9 md:w-9" asChild>
            ...
            <Button variant="ghost" size="icon" className="relative h-6 w-6 md:h-9 md:w-9">
            ...
            <Button variant="ghost" size="icon" className="h-6 w-6 md:h-9 md:w-9">
              <User className="h-3.5 w-3.5 md:h-5 md:w-5" />
              <span className="sr-only">Profile</span>
            </Button>
          </div>
          <Button size="sm" className="text-[10px] md:text-xs h-6 md:h-8 bg-gradient-primary hover:bg-primary/90 px-2 md:px-3">
            Premium
          </Button>
        </div>
      </div>
